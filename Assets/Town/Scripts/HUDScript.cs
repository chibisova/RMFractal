...
namespace SVS
{
    public class HUDScript : SceneViewFilter
    {
        ...
        [SerializeField] private TreeGenerator TreeSpawner;
        ...
        public void TitleUp()
        {
            if (TreeSpawner.title < TreeGenerator.NUM_OF_TREES)
            {
                TreeSpawner.title++;
        ...
        {
            if (TreeSpawner.iterations < TreeGenerator.MAX_ITERATIONS)
            {
        ...
        public void TitleInputOVC()
        {
            ...
            {
                TreeSpawner.title = Mathf.Clamp(tempInt, 1, TreeGenerator.NUM_OF_TREES);
            }
        }
        ...
        public void IterationsInputOVC()
        {
            ...
            {
                TreeSpawner.iterations = Mathf.Clamp(tempInt, 1, TreeGenerator.MAX_ITERATIONS);
            }
        }
